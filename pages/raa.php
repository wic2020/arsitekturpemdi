...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
    ...
    <div class="flex gap-2">
        <a href="cetak/cetak_referensi.php?jenis=raa" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-md border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50">
